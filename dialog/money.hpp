...
onLoad = "[] spawn life_fnc_money";
  ...
  class controlsBackground {
    class imagebackground: Life_RscPictureKeepAspect
    {
    	idc = -1;
      //moving = 1;
    	text = "VOLTICRP\images\textures\Phone\phoneMoney.paa";
    	x = -0.0625;
    	y = -0.3;
    	w = 1.1375;
    	h = 1.5;
    ...
    {
    	idc = -1;
      text = "VOLTICRP\images\textures\Phone\subIcons\bankPhone.paa";
      x = 0.47;
      y = 0.09;
      w = 0.029 * safezoneW;
			h = 0.049 * safezoneH;
    ...
    {
    	idc = -1;
      text = "VOLTICRP\images\textures\Phone\subIcons\inhandPhone.paa";
      x = 0.47;
      y = 0.29;
      w = 0.029 * safezoneW;
			h = 0.049 * safezoneH;
