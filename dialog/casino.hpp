...
class casino
{
	...
	class controls
	{
		...
		{
			idc = 40057;
			text = "VOLTICRP\images\textures\casino\buttonup.paa";
		...
		{
			idc = 40059;
			text = "VOLTICRP\images\textures\casino\slot.jpg"; //--- ToDo: Localize;
			x = 0.288021 * safezoneW + safezoneX;
		...
		{
			idc = 40062;
			text = "VOLTICRP\images\textures\casino\bar.jpg"; //--- ToDo: Localize;
