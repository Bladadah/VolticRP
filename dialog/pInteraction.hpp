...
class pInteraction_MenuCop {
    ...
    class controlsBackground {
        ...
        {
            idc = 1201;
            text = "VOLTICRP\images\textures\HUD\INT-COP-PLAYER.paa";
...
class pInteraction_MenuCiv {
    ...
    class controlsBackground {
        ...
        {
            idc = 1201;
            text = "VOLTICRP\images\textures\HUD\INT-CIV-PLAYER.paa";
...
class vInteraction_MenuCopVeh {
    ...
    class controlsBackground {
       class back: life_RscPicture
        {
            idc = 1201;
            text = "VOLTICRP\images\textures\HUD\INT-COP-VEH.paa";
...
class vInteraction_MenuCivVeh {
    ...
    class controlsBackground {
       class back: life_RscPicture
        {
            idc = 1201;
            text = "VOLTICRP\images\textures\HUD\INT-CIV-VEH.paa";
