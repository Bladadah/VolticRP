...
_ownsDependency3 = [life_currentExpPerks, "perk_processing_5"] call mav_ttm_fnc_hasPerk;
_ownsDependency4 = [life_currentExpPerks, "perk_processing_6"] call mav_ttm_fnc_hasPerk;
