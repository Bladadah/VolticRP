...
/* Logging and Security Settings*/
    ...
    debit_price = 7500; // Price of purchasing a debit card from the bank.
...
/* System Settings */
    ...
    hospital_heal_fee = 60; //Fee to heal at a hospital NPC
    ...
    paycheck_med = 1150; //Payment for medics
    ...
    vehicle_insurance_multiplier_CIVILIAN = .07; //Civilian Vehicle Insurance Price = Vehicle Buy Price * multiplier 
