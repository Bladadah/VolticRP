...
class ADT {
    ...
    class JobRepair
    {
        file = "core\custom\jobs\Repair";
        class repair{};
    };
	
    class JobImpound
    {
        file = "core\custom\jobs\Impound";
        class jobimpound {};
    };
    class JobConvoy
    { 
        file = "core\custom\jobs\fuelConvoy";
        class fuelConvoy {};
...
class Life_Client_Core {
    ...
    class Quests {
        file = "core\custom\quests\Relics";
        class relic1 {};
        class relic2 {};
        class relic3 {};
        class relic4 {};
    ...
    class Quests2 {
        file = "core\custom\quests\Research";
    ...
    class effigy {
        file = "core\custom\quests\effigy";
        class effigyReward {};
    };
    ...
    class Lumbering {
      file = "core\custom\lumbering";
      class gatherAction;
    };
    
    class autosave 
    {
        file = "core\custom\as\autosave";
        class autoSaveInv {};
