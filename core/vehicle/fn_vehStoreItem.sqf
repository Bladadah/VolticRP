...
//Relic
if (_ctrl == "relic1" || _ctrl == "relic2" || _ctrl == "relic3" || _ctrl == "relic4" || _ctrl == "relicTransport" || _ctrl == "planeTreasure" || _ctrl == "excavator" || _ctrl == "unknown" || _ctrl == "Satellite" || _ctrl == "effigy") exitWith {[localize "STR_NOTF_cannotStoreRelic",true,"slow"] call life_fnc_notificationSystem;};
