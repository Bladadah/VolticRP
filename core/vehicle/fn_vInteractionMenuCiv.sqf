...
if ((life_inv_lockpick >= 1) && {alive life_vInact_curTarget} && {locked _curTarget isEqualTo 1}) then {_Btn5 ctrlEnable true; _Btn5 ctrlSetTooltip "Lockpick Vehicle";} else {_Btn5 ctrlEnable false;};
