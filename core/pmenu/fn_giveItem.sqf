...
//Relic
if (_item == "relic1" || _item == "relic2" || _item == "relic3" || _item == "relic4" || _item == "relicTransport" || _item == "planeTreasure" || _item == "excavator" || _item == "unknown" || _item == "Satellite" || _item == "effigy") exitWith {[localize "STR_NOTF_cannotGiveRelic",true,"slow"] call life_fnc_notificationSystem;};
//A series of checks *ugh*
if (life_is_processing) exitWith {["Cannot send items while processing.",true,"slow"] call life_fnc_notificationSystem;ctrlShow[2002,true];};
