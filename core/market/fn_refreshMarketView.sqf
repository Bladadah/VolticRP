...
else
{
	...
	
	{
		if((_x select 0) == _shortname) exitWith
		{
			...
			{
				ctrlSetText [1200, "VOLTICRP\images\icons\trendup.paa"];
			}
			else
			{
				ctrlSetText [1200, "VOLTICRP\images\icons\trenddown.paa"];
			};
			...
			{
				ctrlSetText [1201, "VOLTICRP\images\icons\trendup.paa"];
			}
			else
			{
				ctrlSetText [1201, "VOLTICRP\images\icons\trenddown.paa"];
			};
		};
	}
