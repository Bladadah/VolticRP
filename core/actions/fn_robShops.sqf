...
if(_shop getVariable ["robbing", false]) exitWith { ["This shop is already being robbed, no spam robbing... Naughty!!",false,"slow"] call life_fnc_notificationSystem; };
...
while{true} do
{
   ...
   _shop setVariable ["robbing", false, true];
