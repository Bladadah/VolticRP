...
if (_classname == "relic1" || _classname == "relic2" || _classname == "relic3" || _classname == "relic4" || _classname == "relicTransport" || _classname == "relicFed" || _classname == "excavator" || _classname == "planeTreasure" || _classname == "Satellite" || _classname == "effigy" || _classname == "unknown" ) exitWith {["You cannot sell relics",true,"slow"] call life_fnc_notificationSystem;};
